...
namespace Linda
{
    ...
    {
        /**
         * Simple parser for commands from console
         */
        class ParserCommand
        {
        public:
        ...
        protected:
            ...
            std::auto_ptr<TupleValue> ParseTupleValue();

            template <class TType>
            std::auto_ptr<QueryValue> ParseQueryValue();

            template<class TType>
            std::auto_ptr<QueryValue> CreateQueryValue(TType value, std::string oper);
